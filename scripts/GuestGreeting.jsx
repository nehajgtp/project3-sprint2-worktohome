          ...
          <Card className={classes.box}>
            <CardContent>
              <Typography className={classes.pos} align="center">
                ...
                <p>
                  Traveling to work is a major factor in the decision to purchase or rent a property for many home owners and renters. However,
            ...
            <Card className={classes.box}>
              <CardContent>
                <Typography className={classes.pos} align="center">
                  Website:
                  {' '}
                  <a href="https://worktohome-sprint2.herokuapp.com/">Link</a>
                  <br />
                  Source Code:
                  {' '}
                  <a href="https://github.com/nehajgtp/project3-sprint2-worktohome">Link</a>
                </Typography>
              </CardContent>
            </Card>
          </Typography>
              ...
              <Card className={classes.name} align="center">
                ...
                <CardContent>
                  ...
                  <Link className={classes.link} href="https://github.com/alialkhateeb99" target="_blank">
                    <img alt="" className={classes.github} src="https://cdn.iconscout.com/icon/free/png-256/github-153-675523.png" />
                  </Link>
